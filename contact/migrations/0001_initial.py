    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('choices', models.TextField(help_text='Comma separated list of choices. Only applicable in checkboxes, radio and dropdown.', verbose_name='choices', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('to_address', models.CharField(help_text='Optional - form submissions will be emailed to these addresses. Separate multiple addresses by comma.', max_length=255, verbose_name='to address', blank=True)),
        ...
        migrations.AddField(
            ...
            name='page',
            field=modelcluster.fields.ParentalKey(related_name='contact_fields', to='contact.ContactPage'),
        ),
    ]
